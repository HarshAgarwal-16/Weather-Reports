...
class MainActivity : AppCompatActivity() {
    ...
    var CITY = "delhi,in"
    val API: String = "7c4c223f52ed2e4f196cbd629001f62a"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var options = arrayOf("delhi,in", "mumbai,in","chennai,in","jaipur,in","gandhinagar,in","gurgaon,in","shimla,in")
